...
public abstract class ActionDispatcher<T> {
    ...
    /**
     * Handle and forward GET requests
     * Throws 404 HTTP status code on unexpected actions
     *
    ...
    /**
     * Handle and forward POST requests
     * Throws 404 HTTP status code on unexpected actions, ie different from creation, edition or search
     *
